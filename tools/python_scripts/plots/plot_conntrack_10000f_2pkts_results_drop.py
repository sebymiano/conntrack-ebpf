...
RESULTS_V1 = f'{sys.path[0]}/../data/results_10000flows_2pkts_v1_drop.csv'
RESULTS_V1NS = f'{sys.path[0]}/../data/results_10000flows_2pkts_v1ns_drop.csv'
RESULTS_V2 = f'{sys.path[0]}/../data/results_10000flows_2pkts_v2_drop.csv'
