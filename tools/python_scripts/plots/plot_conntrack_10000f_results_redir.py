...
RESULTS_V1 = f'{sys.path[0]}/../data/throughput/results_10000flows_v1_redir.csv'
RESULTS_V1NS = f'{sys.path[0]}/../data/throughput/results_10000flows_v1ns_redir.csv'
RESULTS_V2 = f'{sys.path[0]}/../data/throughput/results_10000flows_v2_redir.csv'
...
def create_throughput_fig(narrow=False):
    ...
    output_name = f'{sys.path[0]}/../figures/results_10000flows_redir'
